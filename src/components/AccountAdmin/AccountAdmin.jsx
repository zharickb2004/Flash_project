        ...
        <Form className="w-[600px]">
          <div className="flex w-full  items-center ">
                                ...
                                <div className="">
                                  <input
                                    ...
                                    onChange={async (e) => {
                                     ...
                                     const respsne =  await TodoGetApis.UpdateAdmin(
                                        e.target.files[0]
                                      );
                                      console.log(respsne);
                                    }}
            ...
            <div className="tittleAccount flex bg-green ">
              <h1>
                {account.length > 0
                  ? account[0].name_admin
                  : "Asigna nombre a tu tienda"}
              </h1>
              <p>
                {account.length > 0
                  ? account[0].description_admin
                  : "Asigna descripcion a tu tienda"}
              </p>
            </div>
          </div>

          <div className="boxAccount w-full">
            {account.length > 0 ? (
              account.map((data) => (
                <div className="boxAccount1">
                  ...
                  <div className="containerBox flex items-center w-full">
                    <div className="name">
                      <label>Nombre:</label>
                      <span className="ml-2">{data.name_admin}</span>
                    </div>
                    <div className="bg-gray-100 border rounded-md my-2 p-1">
                      <button
                        onClick={() => {
                          swal.fire({
                            html: `
